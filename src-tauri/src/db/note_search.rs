...
pub mod tests {
    ...
    fn test_search_notes_by_different_roles() {
        ...
        let doc = crate::db::Document {
            ...
            sha256_hash: "hash1234hash1234hash1234hash1234hash1234hash1234hash1234hash1234"
                .to_string(),
            page_count: 10,
        ...
        let note = Note {
            ...
            body_markdown: "Decay slows dramatically after each spaced retrieval attempt."
                .to_string(),
